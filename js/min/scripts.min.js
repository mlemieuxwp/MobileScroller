...
var StarScroller=function(e,n,i){function t(n,t){m.jQueryElement=i(t),j=new ScrollSpeedMonitor(function(n,t,o){p!=o&&(m.jQueryElement.removeClass("up down").addClass(o),p=o);var u=m.jQueryElement.is(":visible");if(u&&s(),m.requiredSpeedInPxPerMs<=n){c(t);var a=t-h;h>-1&&a>m.requiredScrollTimeInMs&&(u||(r(),s(),m.jQueryElement.show(),i(e).scroll(function(){l(p)})))}else c(t,!0)})}function l(n){var i=(S-e.pageYOffset)/S,t=.02;i>=0&&m.jQueryElement.css("opacity")<1&&m.jQueryElement.css("opacity",Number(m.jQueryElement.css("opacity"))+t)}function o(){i("#fade-scroll-sm").slideUp("slow",function(){i("#fade-scroll-big").slideDown("slow"),m.jQueryElement.css("opacity",1)})}function s(){null!=v&&(e.clearTimeout(v),v=null),v=e.setTimeout(function(){a()},m.timeoutInMs)}function c(e,n){(-1==h||n)&&(h=e)}function u(){}function r(){null==y&&(y=e.setInterval(function(){u()},m.animationSpeedInMs))}function a(){h=-1}function f(){i("#fade-scroll-big").animate({height:"60px"},function(){i(this).addClass("js-fade-scroll-sm")})}function d(){i("#fade-scroll-big").animate({height:"167px"},function(){i(this).removeClass("js-fade-scroll-sm")})}var m=this,p="unknown",h=-1,j=null,v=null,y=null,S=i(n).height();return this.animationSpeedInMs=50,this.animationStepInPx=10,this.requiredScrollTimeInMs=100,this.requiredSpeedInPxPerMs=2,this.timeoutInMs=125,i(n).on("click",".js-fade-scroll-click",function(n){n.preventDefault(),e.open(clickThru)}),i(n).on("click","div#fade-scroll-sm",function(e){e.preventDefault(),o()}),i(n).on("click","div#fade-scroll-close",function(e){f()}),i(n).on("click",".js-fade-scroll-sm",function(e){d()}),t}(top.window,top.document,top.jQuery);