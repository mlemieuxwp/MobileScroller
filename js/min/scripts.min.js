...
var StarScroller=function(e,n,i){function t(n,t){m.jQueryElement=i(t),v=new ScrollSpeedMonitor(function(n,t,o){p!=o&&(m.jQueryElement.removeClass("up down").addClass(o),p=o);var r=m.jQueryElement.is(":visible");if(r&&s(),m.requiredSpeedInPxPerMs<=n){c(t);var a=t-h;h>-1&&a>m.requiredScrollTimeInMs&&(r||(u(),s(),m.jQueryElement.show(),i(e).scroll(function(){l(p)})))}else c(t,!0)})}function l(n){var i=(g-e.pageYOffset)/g,t=.02;i>=0&&m.jQueryElement.css("opacity")<1&&m.jQueryElement.css("opacity",Number(m.jQueryElement.css("opacity"))+t)}function o(){i("#fade-scroll-sm").slideUp("slow",function(){i("#fade-scroll-big").slideDown("slow"),m.jQueryElement.css("opacity",1)})}function s(){null!=j&&(e.clearTimeout(j),j=null),j=e.setTimeout(function(){a()},m.timeoutInMs)}function c(e,n){(-1==h||n)&&(h=e)}function r(){}function u(){null==y&&(y=e.setInterval(function(){r()},m.animationSpeedInMs))}function a(){h=-1}function f(){var e=i("#fade-scroll-big").data("min-height");i("#fade-scroll-big").animate({height:e+"px"},function(){i(this).addClass("js-fade-scroll-sm")})}function d(){var e=i("#fade-scroll-big").data("max-height");i("#fade-scroll-big").animate({height:e+"px"},function(){i(this).removeClass("js-fade-scroll-sm")})}var m=this,p="unknown",h=-1,v=null,j=null,y=null,g=i(n).height();return this.animationSpeedInMs=50,this.animationStepInPx=10,this.requiredScrollTimeInMs=100,this.requiredSpeedInPxPerMs=2,this.timeoutInMs=125,i(n).on("click",".js-fade-scroll-click",function(n){n.preventDefault(),e.open(clickThru)}),i(n).on("click","div#fade-scroll-sm",function(e){e.preventDefault(),o()}),i(n).on("click","div#fade-scroll-close",function(e){f()}),i(n).on("click",".js-fade-scroll-sm",function(e){d()}),t}(top.window,top.document,top.jQuery);